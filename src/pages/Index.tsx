    ...
    <div className="flex flex-col">
        ...
        <div className="relative z-10 mx-auto max-w-2xl px-6 py-20 text-center">
          ...
          >
            ...
            <h1 className="text-5xl md:text-6xl font-bold leading-tight tracking-tight mb-4">
              ...
              <span className="text-foreground italic">Vital</span>
            </h1>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {features.map((feature, i) => (
              <motion.div
                ...
                className="group rounded-2xl bg-card p-7 shadow-card hover:shadow-elevated transition-shadow duration-300"
              >
      ...
      <section className="py-16 px-6">
        <motion.div
          ...
          className="mx-auto max-w-2xl rounded-3xl bg-gradient-hero p-10 md:p-14 text-center text-primary-foreground"
        >
